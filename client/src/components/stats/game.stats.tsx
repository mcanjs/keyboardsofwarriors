...
interface IProps {
  correct: number;
  incorrect: number;
  opponentCorrects: number;
}

export default function CompetitiveStat(props: IProps) {
  const { correct, incorrect, opponentCorrects } = props;
  return (
    <div className="w-full flex flex-wrap justify-between p-5">
      <div className="basis-1/3">
        ...
        <div className="stat-title text-green-700 text-sm">Total Corrects</div>
      ...
      <div className="basis-1/3">
        ...
        <div className="stat-title text-red-700 text-sm">Total Incorrects</div>
      ...
      <div className="basis-1/3">
        ...
        <div className="stat-title text-gray-700 text-sm">
          Opponent Corrects
        </div>
        <div className="stat-value text-gray-700">{opponentCorrects}</div>
      </div>
    </div>
  );
}
