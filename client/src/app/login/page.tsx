...
export default function Login() {
  ...
  const [leftEntryRights, setLeftEntryRights] = useState(
    guard.states.request.limit
  );
    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-lg text-center">
        <h1 className="text-2xl font-bold sm:text-3xl">
          The step before going to war!
        </h1>

        <p className="mt-4 text-gray-500">
          By logging in, you can match up with online users and start a
          competitive battle. You can improve your keyboard skills and dominate
          your opponents.
        </p>
      </div>
            ...
            {leftEntryRights < guard.states.request.limit && (
              <div>
                <span className="text-md text-error">
                  ...
                  <span className="pl-1">{leftEntryRights}</span> logins. If you
                  continue to log in incorrectly, you will not be able to log in
                  for {guard.states.request.banMinute} minutes.
                </span>
              </div>
            )}
      ...
      {isBlocked && !guardLoad && (
        <div className="my-3 text-center">
          <span className="text-error">
            Too many incorrect logins. Please try logging in again after the
            time expires.
          </span>
          <GeneralCountdown
            seconds={leftBlockedSeconds}
            onCountdownEnded={blockCountdownEnded}
          />
        </div>
      )}
