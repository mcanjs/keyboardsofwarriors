...
import Matcher from '@/servers/matcher.server';
...
import Competitive from '@/servers/competitive.server';
...
export default class CompetitiveSocket {
  ...
  private changeOnlineUserStatements(type?: 'increase' | 'decrease'): void {
    ...
    this.io.of('/').emit('system:online-users', this.onlineUsers);
  }
